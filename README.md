...
let settings = {
  ...
  body: <?xml version='1.0' encoding='UTF-8' standalone='yes'?>
        ...
        </sbgn>[{"text":"Arc with class consumption must have source reference to glyph of EPN classes\n","pattern":"pd10101","role":"a2","errorNo":1,"label":" - GA-3P","colorCode":"#ff0000","status":"unsolved","fixCandidate":[]},{"text":"Arc with class consumption must have target reference to port on glyph with PN classes\n","pattern":"pd10102","role":"a2","errorNo":2,"label":" - GA-3P","colorCode":"#ff0000","status":"unsolved","fixCandidate":[]}]{imageOptions":{"format":"png","background":"transparent","color":"bluescale","autoSize":"true","highlightWidth":10}} // file_content + JSON.stringfy(error_content) + JSON.stringfy(options)
};
