...
|   pd10103  	| The 'empty set' glyph can be connected to at most one consumption arc                                                                      	| Highlight 'empty set' glyph that does not comply with the rule                                     	| Split the 'empty set' glyph for each consumption arc                                                                                                  	|
...
|   pd10107  	| The 'empty set' glyph can be connected to at most one production glyph                                                                     	| Highlight 'empty set' glyphs that do not comply with the rule as well as the connected arcs        	| Split the 'empty set' glyph for each production arc                                                                                                    	|
