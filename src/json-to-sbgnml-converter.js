...
const jsonToSbgnml = {};
   ...
   */
  jsonToSbgnml.buildJsObj = function(filename, version, renderInfo, mapProperties, nodes, edges, cy){
    var self = this;
...
/*     var collapsedChildren = elementUtilities.getAllCollapsedChildrenRecursively(this.nodes);
    ...
    this.edges.each(function(ele, i){
       if(typeof ele === "number") {
         ele = i;
       }
       var arc = self.getArcSbgnml(ele, cy);
       if (version === "plain" || version ==="plain3")
         arc.extension = null;
       map.addArc(self.getArcSbgnml(ele, cy));
    });
  ...
  jsonToSbgnml.getArcSbgnml = function(edge, cy){
    var self = this;
